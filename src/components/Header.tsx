    ...
    <header className="w-full bg-white border-b border-gray-200">
      <div className="max-w-[1600px] mx-auto">
        <div className="flex items-center py-4">
          ...
          <div>
            <div className="flex items-center gap-6 pr-4 md:pr-8 lg:pr-24 ml-auto lg:ml-0">

              <div
                className="hidden lg:flex items-center relative lg:ml-6 mt-[2px]"
                ...
                {showSupportBox && (
                  <div className="absolute top-full right-0 mt-3 w-72 bg-white border border-gray-200 shadow-xl rounded-xl p-4 z-50">
                    ...
                    <div className="space-y-2 text-sm font-jakarta text-black/80">
                      ...
                      <p>💬 <strong>WhatsApp:</strong> (83) 98888-8888</p>
